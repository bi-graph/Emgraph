...
import logging
from bigraph.losses._loss_constants import LOSS_REGISTRY
...
from bigraph.training.sgd import SGD
from bigraph.initializers._initializer_constants import INITIALIZER_REGISTRY, DEFAULT_GLOROT_IS_UNIFORM
...
from bigraph.utils import constants as constants
import time
...
class EmbeddingModel(abc.ABC):
    ...
    def _calibrate(self, X_pos, X_neg=None, positive_base_rate=None, batches_count=100, epochs=50):
        ...
        >>> from bigraph.models import TransE
        >>>
        >>> X = load_wn11()
