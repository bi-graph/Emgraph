...
from bigraph.datasets import OneToNDatasetAdapter
from bigraph.training.sgd import SGD
from bigraph.evaluation import to_idx
...
class ConvE(EmbeddingModel):
    ...
    >>> import numpy as np
    >>> from bigraph.models import ConvE,
    ...
    def _save_trained_params(self):
        ...
        if self.embedding_model_params['use_batchnorm']:
            ...
            for scope in ['batchnorm_input', 'batchnorm_conv', 'batchnorm_dense']:
                ...
                bn_dict[scope] = {'beta': var_dict['beta'],
